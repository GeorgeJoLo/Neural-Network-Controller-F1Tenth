...
class State:
    ...
    def setup(args):
        ...
        State.moving_avg_window = args.moving_avg_window
    ...
    def process_data(self, data):
        ...
        if State.lidar_reduction_method == 'moving_avg':
            data = np.convolve(data, np.ones(State.moving_avg_window)  / State.moving_avg_window, 'valid')
